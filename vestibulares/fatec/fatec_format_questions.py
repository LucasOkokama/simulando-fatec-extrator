  ...
  try:
    ...
    with open('gemini-api-key.txt', 'r', encoding='utf-8') as api_key_txt:
      ...
      for num_questao in range(1, 55):
        ...
        print(f"> Criando JSON da questao {num_questao}")
        ...
        print(f"> Identificando o texto de suporte da questao {num_questao}")
        # Retorna o custo de Token da requisição
        ...
        print(f"> Identificando disciplina da questao {num_questao}")
        # Retorna o custo de Token da requisição
        ...
        print(f"> Identificando gabarito da questao {num_questao}")
        # Retorna o custo de Token da requisição
